...
<%
           ...
           if(user.getType().endsWith("company")){
        %>
         <!-- SIDEBAR -->
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						<a class="active" href="com-page.jsp?pgprt=0"><h2>Profile</h2></a>
			...
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						<a class="active" href="-page.jsp?pgprt=0"><h2>Profile</h2></a>
           ...
           <div class="profile ">
               <h2><span class="tag">Company</span><span class="val"><%=user.getFirstName()%></span><br/>
               ...
               %>
               <br/>
               <a href="com-page.jsp?pgprt=0&pedt=1"><span class="add-btn">Edit Profile</span></a>
               <% 
               }else{
               %><br/>
               <a href="can-page.jsp?pgprt=0&pedt=1"><span class="add-btn">Edit Profile</span></a>
               <% 
               }
               %>
