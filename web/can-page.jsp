...
<body>
    ...
    <%
           ...
           if(session.getAttribute("userStatus").equals("1")){
            ...
            <div class="menu">
            <a href="can-page.jsp?pgprt=0" class="button">profile</a>
            <a class="button" href="can-page.jsp?pgprt=1">exams</a>
            <a class="button" href="can-page.jsp?pgprt=2">results</a>
            <a class="button" href="can-page.jsp?pgprt=3">explore</a>
            <a href="controller.jsp?page=logout" class="button" style="float: right;background:crimson;color:white">Logout</a>
            </div>
            <% 
            //pgpart = pagepart, exams=1,results=2,explore=3 and profile is default
